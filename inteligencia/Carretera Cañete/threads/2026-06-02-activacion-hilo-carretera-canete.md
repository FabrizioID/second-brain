...
- Matiz corregido: no toda actividad debe desglosarse por especialidad. La taxonomia de especialidades aplica cuando el requisito pide modelos, fichas, metrados, validacion o compatibilizacion por disciplina; ademas deben existir actividades transversales que no se repiten por especialidad, como definir plantilla, consolidar matriz, emitir informe, validar aprobacion, publicar en CDE, exportar NWD, preparar evidencia o gestionar visados.
- Regla de equilibrio Magnus: evitar dos errores opuestos. Error 1: empaquetar demasiadas cosas en una sola actividad. Error 2: desglosar todo usando una sola dimension y perder actividades transversales. El desglose final debe combinar unidades por taxonomia dominante con actividades de preparacion, coordinacion, QA, consolidacion, entrega y cierre.
- Criterio de cierre de entregable: el desglose no debe limitarse a reflejar la taxonomia. Cada actividad debe explicar como ayuda a resolver/cerrar el entregable u observacion. Si una tarea no aporta evidencia, decision, correccion, validacion, integracion, publicacion o cierre verificable, no debe crearse aunque encaje en la estructura.
